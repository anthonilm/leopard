...
export default function WhoWeAreHorizontal() {
  ...
  return (
    <section
      className="who-we-are-section--horizontal"
      aria-label="Who We Are"
      role="region"
    >
      <motion.h1
        className="who-headline--horizontal"
      ...
      <div className="who-scroll-row" tabIndex={0}>
        {sections.map((sec, i) => (
          <motion.div
            className="section-group--horizontal"
            key={sec.title}
          ...
          >
            ...
            <div className="section-tile--horizontal">
              <div className="tile-icon--horizontal">{sec.icon}</div>
              <p>{sec.description}</p>
              <button
                className="learn-more-button--horizontal"
